...
ADD https://api.github.com/repos/TaixMiguel/Congatudo/git/refs/heads/master /usr/src/version.json

# Download valetudo
RUN git clone --depth 1 https://github.com/TaixMiguel/Congatudo --branch release .
